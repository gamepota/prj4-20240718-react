...
public class MessageService {
	...
	public List<ChatMessage> getMessagesForRoom(Integer senderId, Integer recipientId) {
		return messageMapper.findMessagesByRoom(senderId, recipientId); // 채팅방에 대한 메시지 반환
	}
}
